...
ny_nwi <- vect("Data/NWI/NY_Wetlands_6350.gpkg")
ny_state <- vect("Data/NWI/NY_6350.gpkg")
ny_hucs <- vect("Data/NY_HUCS/NY_HUCS_08_6350.gpkg")

huc_nums <- values(ny_hucs[, "huc12"])[1:3,]
